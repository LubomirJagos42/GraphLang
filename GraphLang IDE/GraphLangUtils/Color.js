...
GraphLang.Utils.Color = draw2d.util.Color.extend({
  ...
  getByNameBackgroundColor: function(colorName){
    ...
    else if (colorName == "int" || colorName == "int*") return "#0000FF";
    else if (colorName == "int8" || colorName == "uint8*") return "#FFFFFF";
    else if (colorName == "uint8" || colorName == "uint" || colorName == "uint8*" || colorName == "uint*") return "#FFFFFF";
    else if (colorName == "int16" || colorName == "int16*") return "#FFFFFF";
    else if (colorName == "uint16" || colorName == "uint16*") return "#FFFFFF";
    else if (colorName == "int32" || colorName == "int32*") return "#FFFFFF";
    else if (colorName == "uint32" || colorName == "uint32*") return "#FFFFFF";
    else if (colorName == "single" || colorName == "single*") return "#FFFFFF";
    else if (colorName == "float" || colorName == "float*") return "#FFC300";
    else if (colorName == "double" || colorName == "double*") return "#FFFFFF";
    else if (colorName == "bool" || colorName == "boolean" || colorName == "bool*" || colorName == "boolean*") return "#009900";
    else if (colorName == "string" || colorName == "String" || colorName == "string*" || colorName == "String*") return "#ff3385";
    else if (colorName.toLowerCase().search("cluster") > -1) return "#7D1A4C";
    else if (colorName == "errorDatatype" || colorName == "errorDatatype*") return "#cccc00";
    else if (colorName == "broken") return "#666666";
