...
// http://www.draw2d.org
//
GraphLang.Shapes.Basic.SelectOptionDefinedValues = draw2d.shape.basic.Label.extend({

    NAME: "GraphLang.Shapes.Basic.SelectOptionDefinedValues",
    ...
    init:function(attr, setter, getter)
    {
         ...
         */
        this.add(
            new draw2d.shape.basic.Label({text: "pred. value", stroke: 0}),
        ...
        this.optionEditor = new draw2d.ui.SelectOptionInplaceEditor();
    ...
    translateToCppCode: function(){
        ...
        outputPort.getConnections().each(function(wireIndex, wireObj){
            cCode += wireObj.getVariableName() + " = " + figureObj.getText() + ";\n";
        });
        return cCode;
    },
