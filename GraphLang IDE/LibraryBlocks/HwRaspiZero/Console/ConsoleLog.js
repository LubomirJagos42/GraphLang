...
// http://www.draw2d.org                                  
//                                                        
HwRaspiZero.Console.ConsoleLog = GraphLang.UserDefinedNode.extend({

   NAME: "HwRaspiZero.Console.ConsoleLog",
   ...
   layerShow: function(name, flag, duration)
   {
    ...
    translateToCppCode: function(){
        cCode = `console.log(${this.getInputPort(0).getConnections().first().getVariableName()});\n`;
        return cCode;
    }
