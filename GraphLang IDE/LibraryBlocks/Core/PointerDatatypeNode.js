 ...
 */
GraphLang.Shapes.Basic.PointerDatatypeNode = GraphLang.Shapes.Basic.ConstantNode.extend({
    NAME: "GraphLang.Shapes.Basic.PointerDatatypeNode",
    ...
    init: function(attr, setter, getter) {
        ...
        this.installEditor(null);                           //disable editor
    ...
    updateContextMenuItems: function(){
        ...
        /*
         *  This will scan saved files and return clusters and arrayf from them, inside it uses jsonDocument variable
         *  therefore it will NOT RETURN CORRECTLY CLUSTERS AND ARRAY FROM CURRENT EDITING FILE
         *
