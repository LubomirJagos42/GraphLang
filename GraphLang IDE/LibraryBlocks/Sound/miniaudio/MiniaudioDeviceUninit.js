...
// http://www.draw2d.org                                  
//                                                        
GraphLang.Sound.MiniaudioDeviceUninit = GraphLang.UserDefinedNode.extend({

   NAME: "GraphLang.Sound.MiniaudioDeviceUninit",
   ...
   createSet: function()
   {
       this.canvas.paper.setStart();
        ...
        // Label
        shape = this.canvas.paper.text(0,0,'miniaudiodeviceuninit');
        shape.attr({"x":14.080288914184507,"y":62.048000381469706,"text-anchor":"start","text":"miniaudio device uninit","font-family":"Arial","font-size":12,"stroke":"none","fill":"#080808","stroke-scale":true,"font-weight":"normal","stroke-width":0,"opacity":1});
        shape.data("name","Label");
   ...
   layerShow: function(name, flag, duration)
   {
    ...
    translateToCppCode: function(){
        let cCode = "";
        cCode += `ma_device_uninit(&device);\n`;  //TODO: need to unininit device which must be input from wire
        return cCode;
    },
